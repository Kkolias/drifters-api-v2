...
router.post('/handle-qualifying-scoring', driftEventController.handleQualifyingScoring)
router.post('/handle-competition-day-scoring', driftEventController.handleCompetitionDayScoring)
